...
class Bitauth
{
	...
	public function update_user($id, $data)
	{
		...
		if($this->check_existing_username($data['username'],$id))
		{
			$this->set_error("El nombre de usuario ".$data['username']." ya existe");
			return FALSE;
		}
	...
	public function get_user_by_email($email, $include_disabled = FALSE)
	{
	...
	{
		$sql = "SELECT * FROM bitauth_assoc WHERE user_id = '".$this->user_id."' AND group_id = '".(int)$group_id."'";
