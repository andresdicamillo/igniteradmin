...
<html lang="en">
  <head>
    ...
    <link href="<?=base_url()?>assets_be/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen">
    ...
    <script src="<?=base_url()?>assets_common/js/jquery.scrollTo.min.js" type="text/javascript"></script>
