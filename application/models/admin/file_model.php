...
{	
	...
	{
		$this->set_field('file',$this->get_id()."_".str_replace(" ","_",$this->file));
		$this->update(); 	
	}
	...
	{
		return 	$this->file_path.$this->get_thumb_name();
	}	
	...
	public function custom_dir_name($custom_size)
	{
		return $this->file_path.$this->custom_size_name($custom_size);	
	}
	
	public function custom_size_name($custom_size)
	{
		$file_parts = explode('.',$this->file);
		$file_parts[count($file_parts)-2] .= "_".$custom_size;
